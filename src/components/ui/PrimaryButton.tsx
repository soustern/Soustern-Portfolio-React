...
function PrimaryButton({ text, ariaLabel }: PrimaryButtonProps): JSX.Element {
    ...
    return (
        <>
             <motion.button aria-label={ariaLabel} whileHover="hover" whileTap={{scale: 0.9}} transition={{duration: 0.07,}} className="relative px-3 py-1.5 font-heading font-semibold text-sm tracking-wider flex items-center cursor-pointer">

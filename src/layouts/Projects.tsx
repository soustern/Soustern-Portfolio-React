    ...
    if (pageSize.width <= 900)
    {
        return (
            <AnimatePresence>
                ...
                >
                    <div className="flex max-w-[1200px] w-full flex-col gap-8 items-center min-h-0">
                        ...
                        <div  className="flex flex-col w-full items-center gap-8 min-h-0">
